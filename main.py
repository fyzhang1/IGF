...
if not os.path.exists(checkpoint_name):
    ...
    full_model_path = "/home/ecs-user/fgi/federated_weight/retrain/CIFAR100/CIFAR100_federated_full_sample_1000_round_20_partial.pth"
    print(f"Found existing full model at '{full_model_path}', loading weights...")
    full_net.load_state_dict(torch.load(full_model_path))


    unlearned_model_path = "/home/ecs-user/fgi/federated_weight/retrain/CIFAR100/CIFAR100_federated_unlearned_sample_1000_round_20_partial.pth"
